    ...
    <form action="{{ route('users.update', $users->id) }}" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="nombres" name="nombres" value="{{ $users->name }}"
            ...
            <div>
                ...
                <input type="text" id="primer_apellido" name="primer_apellido" value="{{ $users->primer_apellido }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="segundo_apellido" name="segundo_apellido" value="{{ $users->segundo_apellido }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="text" id="cedula" name="cedula" value="{{ $users->cedula }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" id="nacionalidad" name="nacionalidad" value="{{ $users->nacionalidad }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="direccion" name="direccion" value="{{ $users->direccion }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="text" id="ciudad" name="ciudad" value="{{ $users->ciudad }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" id="telefono" name="telefono" value="{{ $users->telefono }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
            ...
            <div>
                ...
                <input type="text" id="celular" name="celular" value="{{ $users->celular }}"
                    class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-500">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-1">
                <label class="block inline-flex items-center mb-2">
                    <input type="radio" class="form-radio" name="sexo" value="V"
                        {{ $users->sexo == 'V' ? 'checked' : '' }}>
                    <span class="ml-2">VARON</span>
                </label>
                <label class="block inline-flex items-center">
                    <input type="radio" class="form-radio" name="sexo" value="M"
                        {{ $users->sexo == 'M' ? 'checked' : '' }}>
