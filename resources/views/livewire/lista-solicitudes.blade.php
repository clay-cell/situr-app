<div class="container mx-auto p-6  rounded-lg shadow-lg">
    ...
    <h2 class="text-2xl font-semibold text-center text-gray-800 mb-6">Lista de Solicitudes Pendientes</h2>
                ...
                <div class="p-4 space-y-2">
                    ...
                    <div x-show="open" x-collapse class="mt-4 text-sm text-gray-700 space-y-2">
                        ...
                        <p class="text-right mt-2">
                            <a href="{{ route('solicitud_usuario.show',$solicitud->id) }}" class="bg-lime-600 text-white p-2 rounded-lg shadow-md hover:bg-lime-500">
